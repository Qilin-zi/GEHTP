...
/* Aliases used by hmx-mm-kernels-tiled.h (originally from ggml matmul-ops.h,
 * not copied; values identical to HMX_FP16_TILE_*). */
#define HTP_MM_HMX_TILE_N_ROWS HMX_FP16_TILE_N_ROWS
#define HTP_MM_HMX_TILE_N_COLS HMX_FP16_TILE_N_COLS
#define HTP_MM_HMX_TILE_N_ELMS HMX_FP16_TILE_N_ELMS
#define HTP_MM_HMX_TILE_SIZE   HMX_FP16_TILE_SIZE
