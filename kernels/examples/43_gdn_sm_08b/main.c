 ...
 * host 侧同源门已绿 (kernels/host/c1b_gdn_08b_host.c 4/4);
 * 本例为设备门, 排队待 DSP 恢复。
 */
#include <stdint.h>
#include <stdio.h>
...
#define DI 6144      /* d_inner (0.8B qkv concat 3x2048) */
#define DCNV 4
#define D  128       /* head_dim 0.8B */
#define H  16        /* heads 0.8B */
#define NT 64        /* tokens 2x32 */
#define CK 32        /* chunk 0.8B seq */
